...
{
public:
    std::string name(){ return "fingerprintzfm"; }
    std::string getTitle() { return "FingerprintZFM"; }
    std::string getVersion() { return "0.1"; }
    std::string getDescription() { return "Plugin to detect fingerprint with adafruit zfm.";}
